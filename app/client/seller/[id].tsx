...
// "Hi {name}" greeting, "Your sale" kicker + non-bold address, the realtor's
// photo circle top-right at the greeting level (tap -> full profile); centered
// below: "N of N steps" above the bigger progress ring, then the days-left
// line ("days left: N" / "due today" / red "overdue by N day(s)"). When every
// step is checked, the banner slot shows "Congratulations, your checklist is
// complete". The single ordered checklist in the realtor's order sits below —
